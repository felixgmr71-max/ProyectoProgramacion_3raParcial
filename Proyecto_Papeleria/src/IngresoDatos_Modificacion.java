...
public class IngresoDatos_Modificacion extends JDialog {
	...
	public IngresoDatos_Modificacion() {
		...
		txtPrecioCompra.addKeyListener(new KeyAdapter() {
			@Override //Esto nos ayuda a indicarle que el método que estás escribiendo
			//abajo está sobrescribiendo un método que ya existe en una clase padre (herencia) o en una interfaz.
